...
[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/gcp-cloud-run/)
...
```bash
kubectl port-forward deployment/tp-gcp-cloud-run 8080:8080
```
...
```bash
kubectl run load-generator --image=busybox --restart=Never -- /bin/sh -c "while true; do wget -q -O- http://tp-gcp-cloud-run; done"
```
...
# Primary Config File: cloud_run.tf
```
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/gcp-cloud-run/) |
