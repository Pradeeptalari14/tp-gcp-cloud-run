...
Thank you for your interest in improving the **GCP Cloud Run Serverless Studio** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-gcp-cloud-run.git
...
Generated configurations come from the **[GCP Cloud Run Serverless Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/gcp-cloud-run/)**.
